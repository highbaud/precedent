/**
 * Markdown-lite renderers shared by the document components. Kept out of
 * ProposalDoc.tsx so that file exports only its component (react-refresh).
 */

/** Render the lightweight markdown used in templates into printable blocks. */
